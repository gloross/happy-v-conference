  ...
  const competitorMatrix = {
    prepro: {
      ...
      rows: [
        ...
        [
          'Label transparency',
          'Full disclosure',
          '"Complexes" — no per-strain CFU',
          'Strain IDs but no per-strain CFU',
          'No per-strain CFU',
        ],
    ...
    cranberry: {
      ...
      rows: [
        [
          'Mechanism',
          'Anti-adhesion + flush + acidify',
          'Biofilm cleansing only',
          'No D-Mannose mechanism',
    ...
    meno: {
      ...
      rows: [
        ...
        [
          'Key actives',
          '5 patented branded ingredients',
          '1 (ERr 731® Rhubarb)',
          '1 (Cytoplasmic Blend)',
          '1 (RemiSure® Black Cohosh)',
        ],
        [
          'Clinical evidence',
          '5 patents w/ cited studies',
          '2-year safety study',
          '3 placebo-controlled trials',
          '35+ studies, 13k+ women',
        ],
